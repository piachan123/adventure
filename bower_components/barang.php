...
<table class="table table-striped">
  ...
  <tr>    
              ...
              <td><?php echo "
                <a href='editbarang.php?id=$row[id_barang]' class='btn btn-warning'><i class='fa fa-pencil'></i></a>
                <a href='deletebarang.php?id=$row[id_barang]' class='btn btn-danger'><i class='fa fa-trash'></i></a>
                "; ?>
            </td>
          </tr>
...
<center>
<a class="btn btn-primary" href="tambahbarang.php"> + Tambah data barang</a>
</center>
</section>
