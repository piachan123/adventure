...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input value="<?php echo $row['id_barang']; ?>" type="text" class="form-control" name="id_barang" placeholder="Masukkan ID barang">
  </div>
  <form action="">
  <div class="form-group">
    <label>Nama Barang</label>
    <input value="<?php echo $row['nama_barang']; ?>" type="text" class="form-control" name="nama_barang" placeholder="Masukkan nama barang">
  </div>
  <div class="form-group">
    <label>Jumlah Barang</label>
    <input value="<?php echo $row['jumlah']; ?>" type="text" class="form-control" name="jumlah" placeholder="Masukkan jumlah barang">
  </div>
  <div class="form-group">
    <label>Harga Barang</label>
    <input value="<?php echo $row['harga']; ?>" type="text" class="form-control" name="harga" placeholder="Masukkan harga barang">
  </div>
  <div class="form-group">
    <label>Deskripsi Barang</label>
    <input value="<?php echo $row['deskripsi']; ?>" type="text" class="form-control" name="deskripsi" placeholder="Masukkan deskripsi barang">
  </div>
